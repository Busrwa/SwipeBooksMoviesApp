...
export default function HelpSupportScreen() {
  ...
  const handleFeedbackPress = () => {
    // Gelecekte özel bir ekranla değiştirilebilir
    Alert.alert(
      'Geri Bildirim',
...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 20, fontWeight: '600', color: '#222', marginVertical: 16 },
  faqBlock: { marginBottom: 15 },
  question: { fontSize: 16, fontWeight: 'bold', color: '#444' },
  answer: { fontSize: 15, color: '#555', marginTop: 4 },
  text: { fontSize: 15, color: '#444', marginBottom: 10 },
  emailLink: {
    fontSize: 16,
    color: '#e53935',
